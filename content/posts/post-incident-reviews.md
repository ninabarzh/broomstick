---
title: "Post-incident reviews that miss the point"
date: 2026-04-07
description: "After every significant security incident, there is a retrospective. Findings are documented, actions assigned, tickets closed. Then the next incident arrives, looking suspiciously familiar."
tags:
  - incident response
  - retrospective
  - root cause analysis
...
* The [facilitator](https://purple.tymyrddin.dev/docs/incident-response/facilitator-guidance) has no stake in the outcome
...
* Procedural: update a [play or runbook](https://purple.tymyrddin.dev/docs/incident-response/playbooks/), add a step, send a reminder
...
The difficult part is not templates or 
[facilitation techniques](https://purple.tymyrddin.dev/docs/incident-response/facilitator-guidance). It is making it 
possible to say true things without those truths being used against the people who say them.
